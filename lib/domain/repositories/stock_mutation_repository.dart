...
abstract class StockMutationRepository {
  ...
  Future<List<StockMutationEntity>> getByEventAndSpg(String eventId, String spgId);
  Future<List<StockMutationEntity>> getByEventSpgProduct(String eventId, String spgId, String productId);
